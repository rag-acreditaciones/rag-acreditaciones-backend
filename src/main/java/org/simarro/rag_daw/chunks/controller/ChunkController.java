 ...
 *   GET    /api/v1/chunks/documento/{docId}/stats   → Estadísticas de chunks del documento
 ...
 *
 * Para la búsqueda semántica, se invoca el VectorStore (caja negra del profesor)
...
public class ChunkController {
    ...
    // TODO ALUMNO: Descomentar cuando creéis ChunkService
    ...
    public ResponseEntity<?> getChunksByDocumento(
            ...
            @RequestParam(defaultValue = "ordenChunk,asc") String[] sort) {
        // TODO ALUMNO: chunkService.findByDocumentoId(docId, estado, page, size, sort)
        throw new UnsupportedOperationException(
            "GET /api/v1/chunks/documento/{docId} — No implementado (Equipo 2)");
    }
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<?> getChunk(@PathVariable Long id) {
        // TODO ALUMNO: chunkService.findById(id)
        throw new UnsupportedOperationException("GET /api/v1/chunks/{id} — No implementado (Equipo 2)");
    }
