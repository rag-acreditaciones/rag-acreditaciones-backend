...
public interface ConversacionRepository
                extends JpaRepository<ConversacionDb, Long>, JpaSpecificationExecutor<ConversacionDb> {
        ...
        Page<ConversacionDb> findByUsuarioIdAndSeccionTematica(Long usuarioId, String seccionTematica,
                        Pageable pageable);
