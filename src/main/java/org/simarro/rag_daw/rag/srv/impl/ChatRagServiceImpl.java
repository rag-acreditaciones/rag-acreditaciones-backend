...
public Flux<String> preguntarStream(String pregunta, String seccion, Long ragConfiguracionId) {
     ...
     * ANTES:
     * private ChatClient buildChatClient(RagClientBundle bundle, SearchRequest searchRequest) {
    ...
    /**
     * Recupera manualmente los IDs de los documentos más similares para incluirlos en el DTO.
     */
