...
public class ValoracionServiceImpl implements ValoracionService {
    ...
    @Override
    public ValoracionDTO crearOActualizar(ValoracionCreateDTO dto, String emailUsuario) {
        ...
        valoracion.setValoracion(ValoracionDb.TipoValoracion.valueOf(dto.getValoracion()));
    ...
    @Override
    public List<ValoracionDTO> findByMensajeId(Long mensajeId) {
    ...
    public ValoracionResumenDTO getResumenConversacion(Long conversacionId) {
        ...
        double ratio = total == 0 ? 0 : (double) positivas / total;
        
        List<ValoracionDTO> detalles = valoraciones.stream()
            .map(this::mapToDTO)
            .collect(Collectors.toList());
        
        return new ValoracionResumenDTO(positivas, total - positivas, ratio, detalles);
    }
